...
// if clicked on json hide the textarea
...
// if clickred on custom show the textarea
...
addParam.addEventListener('click', () => {
    ...
    let string = `<div class="form-row my-2" style="display: flex;">
...
submit.addEventListener('click', () => {
    //please wait request
    document.getElementById('responseJsonText').value = 'Please Wait! Fetching the Data';

    //fetchng all the values
